...
function StudentYearAndBranchView() {
  ...
  const [firstYearMCA, setFirstYearMCA] = useState([]);
  ...
  const [secondYearMCA, setSecondYearMCA] = useState([]);
  ...
  const [thirdYearMCA, setThirdYearMCA] = useState([]);
  ...
  const [fourthYearMCA, setFourthYearMCA] = useState([]);
  ...
  const fetchStudentsData = async () => {
    try {
      ...
      setFirstYearMCA(response.data.firstYearMCA);
      ...
      setSecondYearMCA(response.data.secondYearMCA);
      ...
      setThirdYearMCA(response.data.thirdYearMCA);
      ...
      setFourthYearMCA(response.data.fourthYearMCA);
