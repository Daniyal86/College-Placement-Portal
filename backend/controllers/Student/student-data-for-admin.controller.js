...
const StudentDataYearBranchWise = async (req, res) => {
  try {
    ...
    return res.json({ firstYearComputer, firstYearCivil, firstYearMCA, firstYearAIDS, firstYearMechanical, secondYearComputer, secondYearCivil, secondYearMCA, secondYearAIDS, secondYearMechanical, thirdYearComputer, thirdYearCivil, thirdYearMCA, thirdYearAIDS, thirdYearMechanical, fourthYearComputer, fourthYearCivil, fourthYearMCA, fourthYearAIDS, fourthYearMechanical });
  } catch (error) {
